...
{% hint style="info" %}
Using the AI-assisted response feature consumes AI credits. See the [AI Assistant](../../../features/generalites/ai-assistant/) page for details on your quota and usage.
{% endhint %}
