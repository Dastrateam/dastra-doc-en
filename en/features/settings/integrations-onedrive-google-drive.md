...
By default, Dastra's [document management system](../../../features/gestion-de-documents-ged/) relies on Azure Blob Storage: files are encrypted, scanned for viruses, and redundantly stored on a secondary server. For more details, see the [security documentation](../../security/general.md).
