...
<figure><img src="../../.gitbook/assets/screenshot-2023-01-24-173945.png" alt=""><figcaption></figcaption></figure>
...
The good news is that Dastra handles both approaches perfectly! You can either create a form automatically [by taking a processing template](use-a-treatment-model.md). If you prefer the automatic approach, it's possible to create your own data map and create a treatment directly from an asset (software, database).
